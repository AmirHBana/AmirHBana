...
<div>
      ...
      >
        <title id="titleId">Destiny Franks' GitHub Stats, Rank: B</title>
        <desc id="descId">Total Stars Earned: 280, Total Commits in 2024 : 44, Total PRs: 1, Total Issues: 3, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 152.2788989644532;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Amir Hossien Banayi Khalilabad's GitHub Stats</text>
    </g>
      </g>
